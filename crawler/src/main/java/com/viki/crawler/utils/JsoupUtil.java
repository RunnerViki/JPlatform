...
public class JsoupUtil {
	...
	private static final ThreadLocal<Connection> byConnBean = new ThreadLocal<Connection>(){
		protected Connection initialValue() {
			Connection connection = Jsoup.connect(CustomPropertyPlaceholderConfigurer.getProperty("app.login.url"));
			...
			connection.header("Referer", CustomPropertyPlaceholderConfigurer.getProperty("app.login.reffer.url"));
			...
			connection.header("rId", "009b00c5005e00c9" );
